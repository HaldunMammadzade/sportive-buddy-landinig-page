...
const exps: Array<Exp> = [
  {
    label: 'Respondents Survey',
    value: '142',
  },
  {
    label: 'Used such apps',
    value: '7 %',
  },
  {
  ...
  return (
    <Box id="hero" sx={{ backgroundColor: 'background.paper', position: 'relative', pt: 4, pb: { xs: 8, md: 10 } }}>
      <Container maxWidth="lg">
        <Grid container spacing={0} sx={{ flexDirection: { xs: 'column', md: 'unset' } }}>
          <Grid item xs={12} md={7}>
            ...
            >
              ...
              <Box sx={{ '& button': { mr: 2 } }}>
                <ScrollLink to="products" spy={true} smooth={true} offset={0} duration={350}>
                  <StyledButton color="primary" size="large" variant="contained">
                    Get Started
                  </StyledButton>
                </ScrollLink>
                <ScrollLink to="video-section" spy={true} smooth={true} offset={0} duration={350}>
                  <StyledButton color="primary" size="large" variant="outlined" startIcon={<PlayArrowIcon />} onClick={handleTogglePlay}>
          ...
          <Grid item xs={12} md={5} sx={{ position: 'relative' }}>
            ...
            <Box >
              <Image objectFit='contain' src="/images/phone2.png" width={300} height={900} alt="img" />
            </Box>
            <Box position={"absolute"} top={"-60px"} right={"-40px"}>
              <Image objectFit='contain' src="/images/phone1.png" width={300} height={600} alt="img" />
            </Box>
          </Grid>
        </Grid>

        <Box sx={{ position: 'relative' }}>
        <video ref={videoRef} width="100%" height="auto" controls={true}>
        ...
        {/* Experience */}
        <Box sx={{ boxShadow: 2, py: 2, px: 7, borderRadius: 4 }}>
